            ...
            <main>
                ...
                <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-14">
                    <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_380px]">
                        <MotionDiv initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }}>
                            <div className="rounded-lg border border-slate-200 bg-white shadow-sm dark:border-border dark:bg-card">
                                <AnimatePresence mode="wait">
                                    {submitted ? (
                                        ...
                                        <MotionForm key="form" onSubmit={handleSubmit} className="p-5 sm:p-8">
                        ...
                        <MotionAside initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }} className="space-y-5">
