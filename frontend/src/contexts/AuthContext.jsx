...
const getErrorPayload = (result, fallbackMessage) => ({
  success: false,
...
export const AuthProvider = ({ children }) => {
  ...
  const register = async (userData) => {
    try {
      ...
      return getErrorPayload(result, 'Registration failed');
    } catch (error) {
  ...
  const updateProfile = async (profileData) => {
    try {
      ...
      return getErrorPayload(result, 'Profile update failed');
    } catch (error) {
  ...
  const forgotPassword = async (email) => {
    try {
      ...
      return getErrorPayload(result, 'Failed to send reset email');
    } catch (error) {
  ...
  const resetPassword = async (token, password) => {
    try {
      ...
      return getErrorPayload(result, 'Password reset failed');
    } catch (error) {
  ...
  const verifyEmail = async (token) => {
    try {
      ...
      return getErrorPayload(result, 'Email verification failed');
    } catch (error) {
  ...
  const changePassword = async (currentPassword, newPassword) => {
    try {
      ...
      return getErrorPayload(result, 'Password change failed');
    } catch (error) {
